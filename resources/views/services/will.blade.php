    ...
    <div class="container position-relative z-index-1">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-white cs_fs_18 cs_mb_5">
                ...
                <li class="breadcrumb-item active">Will Preparation</li>
            </ol>
        </nav>
        <h1 class="cs_fs_48 cs_fs_lg_36 text-white m-0">Will Preparation</h1>
    </div>
                ...
                <div class="cs_about cs_style_1">
                    <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_15">
                        <div class="cs_section_heading_in">
                            ...
                            <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20">Will Preparation <span class="text-accent">Services</span></h2>
                            <p class="m-0">Our professionals are here to guide you through the various will options available and help you determine which is best suited to your needs. The DIFC Wills Registry offers a common law framework for non-Muslims, allowing them to create a will in English that dictates how their assets will be distributed upon their passing. This service covers all seven emirates in the UAE, ensuring that non-Muslims' estates are managed outside the jurisdiction of UAE Sharia law. The assets covered can include real estate, cash, personal belongings, company shares, bank accounts, and more.</p>
                        </div>
                    </div>
