    ...
    <div class="container position-relative z-index-1">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-white cs_fs_18 cs_mb_5">
                ...
                <li class="breadcrumb-item active">Brand Registration / Trademark Registration</li>
            </ol>
        </nav>
        <h1 class="cs_fs_48 cs_fs_lg_36 text-white m-0">Brand Registration / Trademark Registration</h1>
    </div>
                ...
                <div class="cs_about cs_style_1">
                    <div class="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_15">
                        <div class="cs_section_heading_in">
                            ...
                            <h2 class="cs_fs_48 cs_fs_lg_36 cs_mb_20">Brand Registration / Trademark <span class="text-accent">Registration</span></h2>
                            <p class="m-0">In this digital age, intellectual property and other creative assets can be easily copied, misused and distributed without your knowledge or permission. With our comprehensive suite of intellectual property services, we can help you protect your creative assets locally and internationally and keep competitors from copying your business.</p>
                            <p>Our trademark and copyright registration services will enable you to protect assets such as:</p>
                            <ul class="cs_mb_30 cs_list cs_style_1">
                                <li>Your brand logo, name or slogan</li>
                    ...
                    <div class="cs_progressbar cs_style_1 cs_mb_20">
                        <div class="cs_progressbar_heading d-flex justify-content-between align-items-center cs_mb_8">
                            <h3 class="fw-medium m-0 cs_fs_18">Brand Registration / Trademark Registration</h3>
